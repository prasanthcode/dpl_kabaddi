      ...
      Live <span className="live-dot"></span>
          ...
          {matches.map((match, index) => (
            <div className="single_match_wrapper" key={index}>
              ...
              {isAdmin && (
                <Link to={`/addscore/${match.matchId}`} style={{textDecoration:"none",color:"white"}} className="edit_button">
                  📝 Edit Match
                </Link>
              )}

              {/* Clickable Match */}
              <Link to={status === "upcoming" ? "/upcoming" : status === "completed" ? `/recent/${match.matchId}` : `/live/${match.matchId}`}
                ...
                <div className="vs_container">
                  <div className="img_wrap">
                    ...
                    <div className="team_1">
                      ...
                      {status !== "upcoming" && <span className="teama_score">
                        { match.teamA.score}
                  ...
                  <div className="img_wrap">
                    ...
                    <div className="team_1">
                      {status !== "upcoming" && <span className="teamb_score">
                        { match.teamB.score} 
